...
that performance optimizations or security hardening do not compromise the core
...
*   **Principle**: The core sync logic must be a deterministic state machine,
