...
To ensure a seamless "instant messaging" experience, 1-on-1 chats prioritize
availability.
...
-   **Cleanup**: Once a new `Announcement` is acknowledged by the majority of a
    user's peers, the old ephemeral private keys SHOULD be securely erased.
