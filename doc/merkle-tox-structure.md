...
Merkle-Tox project. The project is split into three core libraries located
within the `rs-toxcore-c` directory, following the established pattern of
sibling projects like `toxcore` and `toxxi`.
